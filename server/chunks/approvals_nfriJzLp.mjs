...
import { $ as $$ApprovalTabs } from "./ApprovalTabs_B8mYpgJI.mjs";
...
const $$Approvals = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { getSession, canAccess } = await import("./auth_B7O2f1Dn.mjs");
  ...
  const { listApprovals, getApprovalMode } = await import("./approvals_Cx7yZQMg.mjs");
