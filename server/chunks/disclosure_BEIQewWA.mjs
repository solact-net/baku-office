...
import { googleStatus, SCOPE_GROUPS } from "./google_BzEj3D-z.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_C0ZnceFT.mjs";
import { getRetentionDays } from "./storage_DPfGoCa3.mjs";
const LIMITED_USE = [
