...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { cachedEntitlement, hasApiKey } = await import("./client_BQ4VG-sy.mjs");
  ...
  const ttsCloudReady = await (await import("./capabilities_C0ZnceFT.mjs")).ttsConfigured(env).catch(() => false);
  ...
  const [{ getMemberModel }, { listSkills }, { listScheduledTasks }] = await Promise.all([
    ...
    import("./skills_BUmFeC_J.mjs"),
    import("./scheduled-tasks_B-tWUcPK.mjs")
  ]);
