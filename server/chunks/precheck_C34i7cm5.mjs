...
import { getSession, canDevelopApps } from "./auth_B7O2f1Dn.mjs";
import { validateDefinition } from "./appdef_Buu1WGRB.mjs";
import { g as getAppDesign } from "./external-apps_BhUnfGrW.mjs";
import { p as preflight } from "./preflight_WR4szEu7.mjs";
import { r as runDraftApp, p as platformInvariantSuspected, f as escalatePlatformInvariant } from "./app-runtime_DS6YdjiC.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_BhUnfGrW.mjs").then((n) => n.B)).recheckDraft(ctx, draftId);
  } catch {
  }
