...
import { APP_SCHEMA, validateDefinition } from "./appdef_Buu1WGRB.mjs";
import { ALLOWED_PERMISSIONS, PRIVILEGED_PERMISSIONS } from "./apps_W2mhsSSD.mjs";
...
async function scanLeakedSecrets(ctx, text) {
  const { listApiKeyNames, getApiKey } = await import("./client_BQ4VG-sy.mjs");
